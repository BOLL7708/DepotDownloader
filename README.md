...
`-appinfo-json`         | writes downloaded appinfo as JSON to the target config directory.
`-manifest-json`        | writes human readable manifest as JSON to the target config directory.
